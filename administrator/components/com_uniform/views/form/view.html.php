...
class JSNUniformViewForm extends JSNBaseView
{
	...
	public function display($tpl = null)
	{
		...
		if (JSNVersion::isJoomlaCompatible('2.5') AND preg_match('/msie/i', $_SERVER['HTTP_USER_AGENT']))
		{
	...
	protected function initToolbar()
	{
		...
		else
		{
			$bar->appendButton('Custom', '<ul class="jsn-menu save-show">
					 <li class="menu-name"><button class="btn btn-small"><i class="icon-save " title="' . JText::_('JSN_UNIFORM_SAVE_AND_SHOW') . '"></i>' . JText::_('JSN_UNIFORM_SAVE_AND_SHOW') . '</button>
					    <ul class="jsn-submenu">
						<li class="parent primary first"><a href="javascript:void(0);"><span class="jsn-icon24 jsn-icon-joomla jsn-icon-component"></span>' . JText::_('JSN_UNIFORM_FORM_VIA_MENU_ITEM_COMPONENT') . '</a>
						    <ul class="jsn-list-items">' . $menu . '</ul>
						</li>
	...
	protected function addAssets()
	{
		...
		// We need some assets in Joomla 2.5
		if (JSNVersion::isJoomlaCompatible('2.5'))
		{
