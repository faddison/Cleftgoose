			...
			if (!empty($this->_items))
			{
				if (JSNVersion::isJoomlaCompatible('2.5'))
				{
					$bar->appendButton('Custom', '<ul class="jsn-menu clearafter">
					 <li class="menu-name"><a href="#" onclick="return false;"><span class="icon-32-export icon-menu"></span>' . JText::_('JSN_UNIFORM_EXPORT') . '</a>
					    <ul class="jsn-submenu">
							<li class="parent primary first"><a target="_blank" href="' . JRoute::_('index.php?option=com_uniform&view=submissions&layout=export&format=raw&e=excel') . '"><span class="jsn-icon24 jsn-icon-joomla jsn-icon-xls"></span>' . JText::_('JSN_UNIFORM_EXPORT_TO_EXCEL') . '</a></li>
							<li class="parent primary"><a target="_blank" href="' . JRoute::_('index.php?option=com_uniform&view=submissions&layout=export&format=raw&e=csv') . '"><span class="jsn-icon24 jsn-icon-joomla jsn-icon-csv"></span>' . JText::_('JSN_UNIFORM_EXPORT_TO_CSV') . '</a></li>
						</ul>
					  </li>
					</ul>');
				}
				...
				{
					$bar->appendButton('Custom', '<ul class="jsn-menu save-show">
					 <li class="menu-name">
					 <button class="btn btn-small">
						<i class=" icon-download" title="' . JText::_('JSN_UNIFORM_EXPORT') . '"></i>' . JText::_('JSN_UNIFORM_EXPORT') . '
					</button>
					    <ul class="jsn-submenu">
						<li class="parent primary first"><a target="_blank" href="' . JRoute::_('index.php?option=com_uniform&view=submissions&layout=export&format=raw&e=excel') . '"><span class="jsn-icon24 jsn-icon-xls"></span>' . JText::_('JSN_UNIFORM_EXPORT_TO_EXCEL') . '</a></li>
						<li class="parent primary"><a target="_blank" href="' . JRoute::_('index.php?option=com_uniform&view=submissions&layout=export&format=raw&e=csv') . '"><span class="jsn-icon24 jsn-icon-csv"></span>' . JText::_('JSN_UNIFORM_EXPORT_TO_CSV') . '</a></li>
					    </ul>
					  </li>
					</ul>');
				}
			...
			else
			{
				if (JSNVersion::isJoomlaCompatible('2.5'))
				{
					$bar->appendButton('Custom', '<ul class="jsn-menu clearafter">
					 <li class="menu-name"><a href="#" onclick="return false;"><span class="icon-32-export icon-menu"></span>' . JText::_('JSN_UNIFORM_EXPORT') . '</a>
					    <ul class="jsn-submenu">
							<li class="parent primary first"><a onclick=\'alert("'.JText::sprintf("JSN_UNIFORM_EXPORT_EMPTY_DATA","submissions").'");return false;\'><span class="jsn-icon24 jsn-icon-joomla jsn-icon-xls"></span>' . JText::_('JSN_UNIFORM_EXPORT_TO_EXCEL') . '</a></li>
							<li class="parent primary"><a onclick=\'alert("'.JText::sprintf("JSN_UNIFORM_EXPORT_EMPTY_DATA","submissions").'");return false;\'><span class="jsn-icon24 jsn-icon-joomla jsn-icon-csv"></span>' . JText::_('JSN_UNIFORM_EXPORT_TO_CSV') . '</a></li>
						</ul>
					  </li>
					</ul>');
				}
				else
				{
					$bar->appendButton('Custom', '<ul class="jsn-menu save-show">
					 ...
					 <button class="btn btn-small">
					    ...
					    <ul class="jsn-submenu">
						<li class="parent primary first"><a onclick=\'alert("'.JText::sprintf("JSN_UNIFORM_EXPORT_EMPTY_DATA","submissions").'");return false;\'><span class="jsn-icon24 jsn-icon-xls"></span>' . JText::_('JSN_UNIFORM_EXPORT_TO_EXCEL') . '</a></li>
						<li class="parent primary"><a onclick=\'alert("'.JText::sprintf("JSN_UNIFORM_EXPORT_EMPTY_DATA","submissions").'");return false;\'><span class="jsn-icon24 jsn-icon-csv"></span>' . JText::_('JSN_UNIFORM_EXPORT_TO_CSV') . '</a></li>
					    </ul>
					  </li>
					</ul>');
				}
