    ...
    function (JSNVisualDesign) {
        ...
        return function (JSNVisualDesign, language) {
            ...
            JSNVisualDesign.register('static-content', {
                ...
                tmpl:'<div class="control-group"><div class="controls">{{html value}}</div></div>'
            });
            ...
            JSNVisualDesign.register('single-line-text', {
                ...
                /* tmpl:'<div class="control-group"><label class="control-label">${label}{{if required==1||required=="1"}}<span class="required">*</span>{{/if}}{{if instruction}}<i class="icon-question-sign"></i>{{/if}}</label><div class="controls"><input {{if maskText==1 || maskText=="1"}}type="password" value="${value}" class="${size} jsn-input-password"{{else}}type="text" placeholder="${value}" class="${size}"{{/if}}/></div></div>'*/
                tmpl:'<div class="control-group"><label class="control-label">${label}{{if required==1||required=="1"}}<span class="required">*</span>{{/if}}{{if instruction}}<i class="icon-question-sign"></i>{{/if}}</label><div class="controls"><input type="text" placeholder="${value}" class="${size}"/></div></div>'
            });
            ...
            JSNVisualDesign.register('choices', {
                ...
                params:{
                    ...
                    values:{
                        ...
                        extra:{
                            type:'group',
                            decorator:'<div class="jsn-form-bar"><div class="pull-left"><div class="control-group"><div class="controls jsn-allow-other"><allowOther/><labelOthers/></div></div></div><div class="pull-right"><randomize/></div><div class="clearbreak"></div></div>',
                            elements:{
                                allowOther:{
                                    type:'checkbox',
                                    field:'allowOther',
            ...
            JSNVisualDesign.register('paragraph-text', {
                ...
                tmpl:'<div class="control-group"><label class="control-label">${label}{{if required==1||required=="1"}}<span class="required">*</span>{{/if}}{{if instruction}}<i class="icon-question-sign"></i>{{/if}}</label><div class="controls"><textarea class="${size}" rows="${rows}" placeholder="${value}"></textarea></div></div>'
            });
            ...
            JSNVisualDesign.register('file-upload', {
                ...
                tmpl:'<div class="control-group"><label class="control-label">${label}{{if required==1||required=="1"}}<span class="required">*</span>{{/if}}{{if instruction}}<i class="icon-question-sign"></i>{{/if}}</label><div class="controls"><input type="file" placeholder="${value}" /></div></div>'
            });
            /* Address field */
            ...
            JSNVisualDesign.register('website', {
                ...
                tmpl:'<div class="control-group"><label class="control-label">${label}{{if required==1||required=="1"}}<span class="required">*</span>{{/if}}{{if instruction}}<i class="icon-question-sign"></i>{{/if}}</label><div class="controls"><input class="${size}" type="text" placeholder="${value}" /></div></div>'
            });
