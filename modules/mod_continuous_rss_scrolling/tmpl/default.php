...
foreach ( $items as $items ) 
{
	...
	@$crs_html = @$crs_html . "<a href='$crs_post_link'>$crs_post_title</a>";
	@$crs_html = @$crs_html . "</div>";
	
	$crs_post_title = trim($crs_post_title);
	@$crs_x = @$crs_x . "crs_array[$crs_count] = '<div class=\'crs_div\' style=\'height:$dis_height;padding:2px 0px 2px 0px;\'><a href=\'$crs_post_link\'>$crs_post_title</a></div>'; ";	
	@$crs_count++;
}
