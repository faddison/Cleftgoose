...
(10, 933, 'option=com_modules&view=module&layout=edit', 136, '', '', '', 'Position "user1"', 'This is a sample module in position âuser1â. All modules in this position will be arranged in vertical column. The whole position will be collapsed, if there are no modules published.', '', '', 'option=com_modules&view=module&layout=edit&id=136', '', '', 0, 1365056381);
