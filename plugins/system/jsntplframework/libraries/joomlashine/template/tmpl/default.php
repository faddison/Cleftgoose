...
$templateManifest = JSNTplHelper::getManifestCache($this->data->template);
...
<div class="jsn-master">
	<div id="jsn-footer" class="jsn-page-footer jsn-bootstrap">
		...
		<ul class="jsn-footer-menu">
			<li class="first">
				<a href="<?php echo $templateLink ?>" target="_blank"><?php echo JText::_($this->data->template) ?> <?php echo $edition ?> v<?php echo $templateManifest->version ?></a>
