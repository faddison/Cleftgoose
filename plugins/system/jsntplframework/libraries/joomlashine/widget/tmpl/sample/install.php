	...
	<div id="jsn-attention" class="alert alert-error hide">
		...
		<ul>
			<li id="jsn-attension-dummy" class="hide">
				...
				<a href="" target="_blank"><?php echo JText::_('JSN_TPLFW_GET_IT_NOW') ?></a>
			</li>
		</ul>
	</div>
</div>
...
<div class="jsn-toolbar">
	...
	<button id="btn-manual-install" class="btn btn-primary hide" disabled="disabled"><?php echo JText::_('JSN_TPLFW_SAMPLE_DATA_BUTTON_INSTALL') ?></button>
	<button id="btn-confirm-install" class="btn btn-primary" disabled="disabled"><?php echo JText::_('JSN_TPLFW_SAMPLE_DATA_BUTTON_INSTALL') ?></button>
</div>
